...
public partial class ServiceWindow : Window
{
    ...
    private List<Service> _Services = DBContext.Services.OrderBy(x => x.Id).ToList();
    ...
    public ServiceWindow(User user, DateTime dateTime)
    {
        _LogUser = user;
        _Time = dateTime;
        ...
        grid_servicesList.DataContext = _LogUser;
        lbox_services.ItemsSource = _Services.ToList();
